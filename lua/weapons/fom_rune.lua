...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -30, 0) },
	["ValveBiped.Bip01_R_Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 41.111, 0) },
...
if CLIENT then	
	...
	_addMagicEntity("Runes", "fom_rune", "fom_weapon_r", "weapon")
else
	util.AddNetworkString("fom_send_rune")
end
...
usermessage.Hook("fom_r_open", function(data)
	...
	self.win.Paint = function()
		...
		surface.SetMaterial(Material("fom/old_paper"))
